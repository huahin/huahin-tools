 ...
 *
 */
public class DwcSummarizerTtest extends SummarizerDriver {
    @Test
    public void testAll1() throws IOException, URISyntaxException {
        List<Record> input = new ArrayList<Record>();
        Record ir1 = new Record();
        ir1.addGrouping("FILE_NAME", "text.txt");
        ir1.addGrouping("FILE_LENGTH", 13L);
        ir1.addValue(Wc.WORDS, 4);
        input.add(ir1);

        List<Record> output = new ArrayList<Record>();
        Record or1 = new Record();
        or1.addGrouping(Wc.LINES, 1);
        or1.addGrouping(Wc.WORDS, 4);
        or1.addGrouping(Wc.CHARS, 13L);
    ...
    @Test
    public void testAll2() throws IOException, URISyntaxException {
        List<Record> input = new ArrayList<Record>();
        Record ir1 = new Record();
        ir1.addGrouping("FILE_NAME", "text.txt");
        ir1.addGrouping("FILE_LENGTH", 13L);
        ...
        ir2.addGrouping("FILE_LENGTH", 13L);
        ir2.addValue(Wc.WORDS, 4);
        input.add(ir2);

        List<Record> output = new ArrayList<Record>();
        Record or1 = new Record();
        or1.addGrouping(Wc.LINES, 2);
        or1.addGrouping(Wc.WORDS, 8);
        or1.addGrouping(Wc.CHARS, 13L);
        or1.addGrouping("FILE_NAME", "text.txt");
        or1.setValueNothing(true);
        output.add(or1);
    ...
    public void testCharsWords() throws IOException, URISyntaxException {
        ...
        setParameter(Wc.CHARS, true);
        setParameter(Wc.WORDS, true);
