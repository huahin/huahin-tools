 ...
 *
 */
public class Dcut extends ToolsTool {
    public static final String FIELDS = "FIELDS";

    private DcutToolsOptionUtil tot;
    ...
    protected void setup() throws Exception {
        ...
        if (!opt.isLocalMode()) {
            job.setFilter(DcutFilter.class);
        } else {
            job.setMapperClass(MultithreadedMapper.class);
            MultithreadedMapper.setMapperClass(job, DcutFilter.class);
    ...
    protected ToolsOptionUtil setToolsOptionUtil(OptionUtil opt)
        ...
        tot = new DcutToolsOptionUtil(opt.getArgs());
        return tot;
    }
}
