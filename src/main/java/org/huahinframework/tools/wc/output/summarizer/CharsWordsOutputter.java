 ...
 *
 */
public class CharsWordsOutputter implements Outputter {
    ...
    public void summarize(Record record) {
        ...
        chars = record.getGroupingLong("FILE_LENGTH");
        words += record.getValueInteger(Wc.WORDS);
    }
