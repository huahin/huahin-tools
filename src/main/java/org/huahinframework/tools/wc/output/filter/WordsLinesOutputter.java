 ...
 */
package org.huahinframework.tools.wc.output.filter;
 ...
 *
 */
public class WordsLinesOutputter implements Outputter {
    /* (non-Javadoc)
    ...
    public void output(Writer writer, Record record)
        ...
        emitRecord.addValue(Wc.WORDS, StringUtil.split(record.getValueString("0"), " ", true).length);
