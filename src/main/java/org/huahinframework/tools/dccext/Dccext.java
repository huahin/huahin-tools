 ...
 *
 */
public class Dccext extends ToolsTool {
    public static final String NUMBER = "NUMBER";
    public static final String REVERSE = "REVERSE";

    private DccextToolsOptionUtil tot;
    ...
    protected void setup() throws Exception {
        ...
        if (!opt.isLocalMode()) {
            job.setFilter(DccextFilter.class);
        } else {
            job.setMapperClass(MultithreadedMapper.class);
            MultithreadedMapper.setMapperClass(job, DccextFilter.class);
    ...
    protected ToolsOptionUtil setToolsOptionUtil(OptionUtil opt)
        ...
        tot = new DccextToolsOptionUtil(opt.getArgs());
        return tot;
    }
}
