 ...
 *
 */
public class Durldec extends ToolsTool {
    public static final String FIELDS = "FIELDS";

    private DurldecToolsOptionUtil tot;
    ...
    protected void setup() throws Exception {
        ...
        if (!opt.isLocalMode()) {
            job.setFilter(DurldecFilter.class);
        } else {
            job.setMapperClass(MultithreadedMapper.class);
            MultithreadedMapper.setMapperClass(job, DurldecFilter.class);
    ...
    protected ToolsOptionUtil setToolsOptionUtil(OptionUtil opt)
        ...
        tot = new DurldecToolsOptionUtil(opt.getArgs());
        return tot;
    }
}
