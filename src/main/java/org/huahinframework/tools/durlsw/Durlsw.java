 ...
 *
 */
public class Durlsw extends ToolsTool {
    public static final String FIELDS = "FIELDS";
    public static final String MASTER = "MASTER";

    private DurlswToolsOptionUtil tot;
    ...
    protected void setup() throws Exception {
        ...
        if (!opt.isLocalMode()) {
            job.setFilter(DurlswFilter.class);
        } else {
            job.setMapperClass(MultithreadedMapper.class);
            MultithreadedMapper.setMapperClass(job, DurlswFilter.class);
    ...
    protected ToolsOptionUtil setToolsOptionUtil(OptionUtil opt)
        ...
        tot = new DurlswToolsOptionUtil(opt.getArgs());
        return tot;
    }
}
